...
# second plot - line plot of observations grouped by weekday of Global Active Power readings
plot(myfile2$dt,myfile2$Global_active_power,type="l",ylab="Global Active Power (kilowatts)",xlab="")
